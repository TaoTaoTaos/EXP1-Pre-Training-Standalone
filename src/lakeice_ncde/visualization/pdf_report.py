        ...
        if bool(physics_cfg.get("enable_stefan_grow", False)):
            ...
            tc2020_pairs.extend(
                [
                    ...
                    ("train.physics_loss.enable_daily_delta_smoothness", str(physics_cfg.get("enable_daily_delta_smoothness", "n/a"))),
                    ("run_summary.physics_enable_daily_delta_smoothness", str(run_summary.get("physics_enable_daily_delta_smoothness", "n/a"))),
                    ("train.physics_loss.lambda_daily_delta_smoothness", str(physics_cfg.get("lambda_daily_delta_smoothness", "n/a"))),
                    ("run_summary.physics_lambda_daily_delta_smoothness", str(run_summary.get("physics_lambda_daily_delta_smoothness", "n/a"))),
                    ("train.physics_loss.daily_delta_huber_beta", str(physics_cfg.get("daily_delta_huber_beta", "n/a"))),
                    ("train.physics_loss.daily_delta_melt_degree_day_factor_m_per_c_day", str(physics_cfg.get("daily_delta_melt_degree_day_factor_m_per_c_day", "n/a"))),
                    ("train.physics_loss.daily_delta_tolerance_m", str(physics_cfg.get("daily_delta_tolerance_m", "n/a"))),
